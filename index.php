...
?>
  ...
  <main>
    <div class="hero">
      <a href="shop.php" class="btn1">View Menu
</a>
    </div>
    <!-- Main -->
    <div class="wrapper">
    ...
    <footer class="page-footer">
      ...
      <div class="footer-nav">
        <div class="container clearfix">
          ...
          <div class="footer-nav__col footer-nav__col--contacts">
            ...
            Head Office: Kukito.<br>
            Nairobi CBD
          </address>
            <div class="phone">
              Telephone:
              <a class="phone__number" href="tel:0723456789">0723-456-789</a>
            </div>
            <div class="email">
              Email:
              <a href="mailto:support@kukito.com" class="email__addr">support@kukito.com</a>
            </div>
          </div>
      ...
      <div class="page-footer__subline">
        <div class="container clearfix">
          ...
          <div class="copyright">
            &copy; <?php echo date("Y");?> KUKITO;
          </div>

          <div class="developer">
            Developed by Booker Ongalo
          </div>

          <div class="designby">
            Design by Booker Ongalo
          </div>
